...
//            event.accept(BBBlocks.BAMBOO_FLOORING_SLAB);
            ...
            event.accept(BBBlocks.TUFF_TILES);
            event.accept(BBBlocks.TUFF_TILE_STAIRS);
            event.accept(BBBlocks.TUFF_TILE_SLAB);
            event.accept(BBBlocks.TUFF_TILE_WALL);

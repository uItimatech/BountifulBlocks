...
public class BBBlocks {
    ...
    public static final DeferredBlock<Block> CARVED_SPRUCE_PLANKS = registerBlock("carved_spruce_planks", () ->
            new BBFlammableBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.SPRUCE_PLANKS), 5, 20));

    public static final DeferredBlock<Block> CARVED_BIRCH_PLANKS = registerBlock("carved_birch_planks", () ->
            new BBFlammableBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.BIRCH_PLANKS), 5, 20));

    public static final DeferredBlock<Block> CARVED_JUNGLE_PLANKS = registerBlock("carved_jungle_planks", () ->
            new BBFlammableBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.JUNGLE_PLANKS), 5, 20));

    public static final DeferredBlock<Block> CARVED_ACACIA_PLANKS = registerBlock("carved_acacia_planks", () ->
            new BBFlammableBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.ACACIA_PLANKS), 5, 20));
    ...
    public static final DeferredBlock<Block> OAK_FLOORING_STAIRS = registerBlock("oak_flooring_stairs", () ->
            new BBFlammableStairBlock(BBBlocks.OAK_FLOORING.get().defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(BBBlocks.OAK_FLOORING.get()), 5, 20));

    public static final DeferredBlock<Block> OAK_FLOORING_SLAB = registerBlock("oak_flooring_slab", () ->
            new BBFlammableSlabBlock(BlockBehaviour.Properties.ofFullCopy(BBBlocks.OAK_FLOORING.get()), 5, 20));

    public static final DeferredBlock<Block> SPRUCE_FLOORING_STAIRS = registerBlock("spruce_flooring_stairs", () ->
            new BBFlammableStairBlock(BBBlocks.SPRUCE_FLOORING.get().defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(BBBlocks.SPRUCE_FLOORING.get()), 5, 20));

    public static final DeferredBlock<Block> SPRUCE_FLOORING_SLAB = registerBlock("spruce_flooring_slab", () ->
            new BBFlammableSlabBlock(BlockBehaviour.Properties.ofFullCopy(BBBlocks.SPRUCE_FLOORING.get()), 5, 20));

    public static final DeferredBlock<Block> BIRCH_FLOORING_STAIRS = registerBlock("birch_flooring_stairs", () ->
            new BBFlammableStairBlock(BBBlocks.BIRCH_FLOORING.get().defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(BBBlocks.BIRCH_FLOORING.get()), 5, 20));

    public static final DeferredBlock<Block> BIRCH_FLOORING_SLAB = registerBlock("birch_flooring_slab", () ->
            new BBFlammableSlabBlock(BlockBehaviour.Properties.ofFullCopy(BBBlocks.BIRCH_FLOORING.get()), 5, 20));

    public static final DeferredBlock<Block> JUNGLE_FLOORING_STAIRS = registerBlock("jungle_flooring_stairs", () ->
            new BBFlammableStairBlock(BBBlocks.JUNGLE_FLOORING.get().defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(BBBlocks.JUNGLE_FLOORING.get()), 5, 20));

    public static final DeferredBlock<Block> JUNGLE_FLOORING_SLAB = registerBlock("jungle_flooring_slab", () ->
            new BBFlammableSlabBlock(BlockBehaviour.Properties.ofFullCopy(BBBlocks.JUNGLE_FLOORING.get()), 5, 20));

    public static final DeferredBlock<Block> ACACIA_FLOORING_STAIRS = registerBlock("acacia_flooring_stairs", () ->
            new BBFlammableStairBlock(BBBlocks.ACACIA_FLOORING.get().defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(BBBlocks.ACACIA_FLOORING.get()), 5, 20));

    public static final DeferredBlock<Block> ACACIA_FLOORING_SLAB = registerBlock("acacia_flooring_slab", () ->
            new BBFlammableSlabBlock(BlockBehaviour.Properties.ofFullCopy(BBBlocks.ACACIA_FLOORING.get()), 5, 20));

    public static final DeferredBlock<Block> DARK_OAK_FLOORING_STAIRS = registerBlock("dark_oak_flooring_stairs", () ->
            new BBFlammableStairBlock(BBBlocks.DARK_OAK_FLOORING.get().defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(BBBlocks.DARK_OAK_FLOORING.get()), 5, 20));

    public static final DeferredBlock<Block> DARK_OAK_FLOORING_SLAB = registerBlock("dark_oak_flooring_slab", () ->
            new BBFlammableSlabBlock(BlockBehaviour.Properties.ofFullCopy(BBBlocks.DARK_OAK_FLOORING.get()), 5, 20));

    public static final DeferredBlock<Block> MANGROVE_FLOORING_STAIRS = registerBlock("mangrove_flooring_stairs", () ->
            new BBFlammableStairBlock(BBBlocks.MANGROVE_FLOORING.get().defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(BBBlocks.MANGROVE_FLOORING.get()), 5, 20));

    public static final DeferredBlock<Block> MANGROVE_FLOORING_SLAB = registerBlock("mangrove_flooring_slab", () ->
            new BBFlammableSlabBlock(BlockBehaviour.Properties.ofFullCopy(BBBlocks.MANGROVE_FLOORING.get()), 5, 20));

    public static final DeferredBlock<Block> CHERRY_FLOORING_STAIRS = registerBlock("cherry_flooring_stairs", () ->
            new BBFlammableStairBlock(BBBlocks.CHERRY_FLOORING.get().defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(BBBlocks.CHERRY_FLOORING.get()), 5, 20));
